// Access DOM of elements of the calculator
...
function updateDisplay(explression, result) {
...
function evaluateExpression() {
    ...
    // checks if evalResult isNan or infinte. It if is, return a space character ' '
